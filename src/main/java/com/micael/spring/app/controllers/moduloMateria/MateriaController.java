...
import com.micael.spring.app.services.moduloMateria.materiaServicios.MateriaService;
...
public class MateriaController {
    ...
    public ResponseEntity<?> view(@PathVariable int id){
        Optional<Materia> valorOptional= service.findById(id);
    ...
    @PostMapping
    public ResponseEntity<?> create(@Valid @RequestBody MateriaDto resp, BindingResult result){
        if(result.hasErrors()){
